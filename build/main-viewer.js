...
/* harmony default export */ var src_style = (style/* default */.Z.locals || {});
...
var PDFViewerApplication = /*#__PURE__*/function () {
  function PDFViewerApplication() {
    ...
    main_viewer_application_defineProperty(this, "_initializeViewer", function () {
      ...
      _this.pdfLinkService = new pdf_viewer.PDFLinkService({
        eventBus: _this.eventBus
      });
      _this.pdfViewer = new pdf_viewer.PDFViewer({
    ...
    main_viewer_application_defineProperty(this, "close", function () {
      ...
      _this.pdfViewer.eventBus = _this.eventBus = new pdf_viewer.EventBus();
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [509], function() { return __webpack_require__(49); })
